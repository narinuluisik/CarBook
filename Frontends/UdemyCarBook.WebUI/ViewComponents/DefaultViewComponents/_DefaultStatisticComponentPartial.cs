...
namespace UdemyCarBook.WebUI.ViewComponents.DefaultViewComponents
{
    public class _DefaultStatisticComponentPartial :ViewComponent
    {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var responseMessage3 = await client.GetAsync("https://localhost:7087/api/Statistic/GetBrandCount");
            ...
            var responseMessage4 = await client.GetAsync("https://localhost:7087/api/Statistic/GetCarCountByFuelElectric");
