...
namespace UdemyCarBook.Persistence.Repositories.CarFeatureRepositories
{
    public class CarFeatureRepository : ICarFeatureRepository
    {
        ...
        {
           var values = _context.CarFeatures.Where(cf => cf.CarFeatureID == id).FirstOrDefault();
        ...
        {
           var values=_context.CarFeatures.Include(y=>y.Feature).Where(cf => cf.CarID == id).ToList();
            return values;
        }
    }
}
